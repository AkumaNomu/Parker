...
Write-Host "Double-click the icon to open recordings."
Write-Host ""
Write-Host "Features:"
Write-Host "  Smart capture (Ctrl+Shift+F8) — QR detection, OCR text, code, and tables"
Write-Host "  Region recording (Ctrl+Shift+F9) — Screen region to MP4"
Write-Host "  Clip recording (Ctrl+Shift+F7) — Last 30-60 second rolling buffer"
Write-Host "  Scroll capture (Ctrl+Shift+F11) — Stitch scrolling screenshots"
Write-Host "  Webpage extraction (Ctrl+Shift+F6) — Save web pages locally"
Write-Host "  Open recordings (Ctrl+Shift+F10)"
Write-Host "  Exit Parker (Ctrl+Shift+F12)"
Write-Host ""
Write-Host "Right-click tray icon: Smart capture, Record, Clip, Scroll capture,"
Write-Host "  Open recordings, Copy last file path, Settings, Exit"
Write-Host ""
Write-Host "OCR (Tesseract) $(& { if ($tesseract) { 'is installed.' } else { 'was not found — install it for text/code/table recognition. QR and recording work without it.' } })"
